...
# [iq
		...
		if HardwareInfo().get_device_name() in ('twin', 'tm2toe' , '2t', 'tmtwinoe' , 'tmsingle', 'tmsinglemini', 'tmnanooe'):
		...
		if HardwareInfo().get_device_name() in ('ios100hd', 'ios200hd' , 'ios300hd' , 'mediabox', 'optimuss os1', 'optimuss os2'):
